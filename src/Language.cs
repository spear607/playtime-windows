...
namespace Playtime {
 public static class L {
  ...
  static readonly Dictionary<string,string[]> Text=new Dictionary<string,string[]> {
   ...
   {"browse",new[]{"选择文件","選擇檔案","Browse","参照"}}, {"desktopShortcut",new[]{"桌面图标","桌面圖示","Desktop shortcut","デスクトップ"}},
   {"desktopPickInfo",new[]{"这里会同时显示个人桌面和公共桌面的快捷方式。","這裡會同時顯示個人桌面與公用桌面的捷徑。","Shortcuts from both your personal and public desktop are shown here.","個人用と共有デスクトップのショートカットを表示します。"}},
   {"advanced",new[]{"高级设置","進階設定","Advanced","詳細設定"}},
   ...
   {"chooseRunning",new[]{"从运行中的窗口选择","從執行中的視窗選擇","Choose a running window","実行中のウィンドウから選択"}},
   ...
   {"startPick",new[]{"先正常启动游戏，再选择它的窗口。列表只显示有可见窗口的程序。","先正常啟動遊戲，再選擇它的視窗。清單只顯示有可見視窗的程式。","Start the game normally, then select its window. Only programs with a visible window are shown.","ゲームを起動してから、そのウィンドウを選択してください。表示中のウィンドウがあるプログラムだけを一覧に表示します。"}},
